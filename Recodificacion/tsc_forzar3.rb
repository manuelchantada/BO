...
while 1 
	...
	until ( count>60 )
		...
		if (a=~/problema de comunicaci/)
			ctrl.puts linea+","+"problema de comunicacion"+","+a.lines.to_a[58].to_s.strip+","+Time.now.strftime("%d/%m/%Y %H:%M")
			     puts linea+","+"problema de comunicacion"+","+Time.now.strftime("%d/%m/%Y %H:%M")
			count=1000
		end	
		...
		if a=~/resultado d/
			...
			window.mouse.move :x => 500, :y => 500
			window.mouse.click
			resultado2=a.lines.to_a[56].to_s.strip+","+a.lines.to_a[57].to_s.strip+","+a.lines.to_a[59].to_s.strip+","+a.lines.to_a[60].to_s.strip+","+a.lines.to_a[61].to_s.strip+","+a.lines.to_a[62].to_s.strip+","+a.lines.to_a[63].to_s.strip+","+a.lines.to_a[64].to_s.strip+","+a.lines.to_a[66].to_s.strip+","+a.lines.to_a[67].to_s.strip+","+a.lines.to_a[68].to_s.strip+","+a.lines.to_a[69].to_s.strip+","+a.lines.to_a[71].to_s.strip
